    ...
    return <div className="footer-main">
        <section className="footer-left">
            <div className="about-site-paragraph">
                ...
                <p className="footer-paragraph">2023 all rights reserved - website by WhaleSpotting Global Limited</p>
            </div>
        </section>
        <section className="footer-right">
            <div className="read-more-section">
            <p className="footer-paragraph">Read more about whales at:</p>
